class Card ():
    ...
    @staticmethod
    def int_to_pretty_str(card_int, colorize=True):
        suit_int = Card.get_suit_int(card_int)
        rank_int = Card.get_rank_int(card_int)
    ...
    @staticmethod
    def pretty_cards_str(card_ints, colorize=False):
        return " ".join([Card.int_to_pretty_str(c, colorize=colorize) for c in card_ints])
    
    @staticmethod
    def compact_cards_str(card_ints):
        return " ".join([Card.int_to_str(c) for c in card_ints])